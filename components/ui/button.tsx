  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-gradient-to-b from-navy-800 to-navy-900 text-white hover:from-navy-700 hover:to-navy-800 shadow-lg shadow-navy-900/20 hover:shadow-xl hover:shadow-navy-900/30",
        accent:
          "bg-cyan-deep text-white hover:bg-cyan-600 shadow-sm hover:shadow-md",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-navy-200 bg-white text-navy-900 hover:bg-navy-50 hover:border-navy-300",
        secondary:
          "bg-navy-100 text-navy-900 hover:bg-navy-200",
        ghost: "text-navy-700 hover:bg-navy-100 hover:text-navy-900",
        link: "text-navy-700 underline-offset-4 hover:underline hover:text-navy-900",
      },
      size: {
